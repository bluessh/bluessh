...
echo -e "${Info} Wireguard VPS AutoScript by Adjie Poetra Pratama"
...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/bluessh/bluessh/main/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/bluessh/bluessh/main/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/bluessh/bluessh/maind/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/bluessh/bluessh/main/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
