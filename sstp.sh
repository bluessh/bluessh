...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/bluessh/bluessh/main/accel.conf"
...
-subj "/C=$country/ST=$state/L=$locality/O=$organization/OU=$organizationalunixxxt/CN=$commonname/emailAddress=$email"
...
#input perintah sstp
wget -O /usr/bin/add-sstp https://raw.githubusercontent.com/bluessh/bluessh/main/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -O /usr/bin/del-sstp https://raw.githubusercontent.com/bluessh/bluessh/main/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -O /usr/bin/cek-sstp https://raw.githubusercontent.com/bluessh/bluessh/main/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -O /usr/bin/renew-sstp https://raw.githubusercontent.com/bluessh/bluessh/main/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh
